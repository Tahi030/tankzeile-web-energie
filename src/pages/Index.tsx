      ...
      <section className="bg-primary py-16">
        <div className="container-custom">
          <div className="text-center text-white max-w-2xl mx-auto">
            ...
            <Link to="/kontakt" className="inline-flex items-center justify-center bg-white text-primary hover:bg-gray-100 transition-colors px-6 py-3 text-lg font-medium rounded-md">
              Kontaktiere mich
