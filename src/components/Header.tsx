        ...
        <div className="flex justify-between items-center py-2">
          ...
          <nav className="hidden md:flex items-center justify-center flex-1">
            <div className="flex items-center justify-center space-x-1 lg:space-x-2">
              ...
              <div className="relative group">
                <div className={`px-2 lg:px-3 py-2 rounded-md text-base lg:text-lg font-medium ${getHoverColor()} transition-all duration-200 cursor-pointer whitespace-nowrap active:scale-95 ${(location.pathname === '/regionally-rooted' || location.pathname === '/meine-angebote/alltag-leichter-leben') ? `${getTextColor()} font-semibold bg-muted/50` : getTextColor()}`}>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white shadow-lg">
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <div className="border-t border-border pt-2">
              <div className={`px-3 py-2 font-medium ${(location.pathname === '/regionally-rooted' || location.pathname === '/meine-angebote/alltag-leichter-leben') ? 'text-primary font-bold' : ''}`}>Mehr</div>
