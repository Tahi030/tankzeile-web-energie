...
export const HeroWelcome = () => {
  return (
    <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-green-100/40 via-yellow-50/60 to-orange-100/50 pt-24 md:pt-20 lg:pt-16">
